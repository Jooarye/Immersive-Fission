...
public class UraniumIngotItem extends ImmersiveFissionModElements.ModElement {
	@ObjectHolder("immersive_fission:uranium_ingot")
	public static final Item block = null;

	public UraniumIngotItem(ImmersiveFissionModElements instance) {
		super(instance, 6);
	}
